...
class MovieGenreController extends Controller
{
    ...
    public function delete($id)
    {
         ...
         * @OA\Delete(
         *   tags={"Movie Genres"},
         *   path="/api/movie-genres/{id}/delete",
         *   summary="Delete a Movie Genre",
         *   @OA\Parameter(
         *     name="id",
         *     in="path",
         *     required=true,
         ...
         * )
         */
        return $this->movieGenreRepo->delete($id);
    }
    ...
    public function remove($id)
    {
         ...
         *   summary="Remove Movie Genre from trash",
         *   @OA\Parameter(
         *     name="id",
         *     in="path",
         *     required=true,
    ...
    public function restore($id)
    {
         ...
         * @OA\Patch(
         *   tags={"Movie Genres"},
         *   path="/api/movie-genres/{id}/restore",
         *   summary="Restore Movie Genre from trash",
         *   @OA\Parameter(
         *     name="id",
         *     in="path",
         *     required=true,
         ...
         * )
         */
        return $this->movieGenreRepo->restore($id);
    }
}
